---
title: "Demonstrating autotool"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Demonstrating autotool}
...
This vignette demonstrates the two main functions in `autotool`:
...
```{r setup}
box::use(autotool[ add, sum_array_cpp ])
```
